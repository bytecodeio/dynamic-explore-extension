...
import "../../../../styles.css";
import AutoSubTable from "../AutoSubTable";
...
const AutoSub = ({currentNavTab,selectedFilters, setSelectedFilters,filterOptions,dateFilterOptions,fieldOptions,isFetchingLookmlFields,selectedDateFilter, setSelectedDateFilter,setSelectedDateRangeStart,
    ...
    <div className="modal-footer">
      ...
      <Row className="mt-3 mb-3">
        <Col md={12}>
                ...
                <AutoSubTable productMovementVisQid={productMovementVisQid} />
