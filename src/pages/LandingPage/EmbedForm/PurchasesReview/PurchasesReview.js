...
import "../../../../styles.css";
import PurchasesTable1 from "../PurchasesTable/PurchasesTable1";
import PurchasesTable2 from "../PurchasesTable/PurchasesTable2";
import PurchasesTable3 from "../PurchasesTable/PurchasesTable3";
import PurchasesTable4 from "../PurchasesTable/PurchasesTable4";
import PurchasesTable5 from "../PurchasesTable/PurchasesTable5";
import PurchasesTable6 from "../PurchasesTable/PurchasesTable6";
...
const PurchasesReview = ({selectedFilters, setSelectedFilters,filterOptions,dateFilterOptions,fieldOptions,isFetchingLookmlFields,selectedDateFilter, setSelectedDateFilter}) => {
      ...
      <Row className="mt-3 mb-3">
        ...
        <Col md={8}>
            ...
            <Row className="mt-5">
                ...
                <p className="mb-4">If the message "Positive and Negative values in chart" appears, use the <span className="highlight">Fast Change</span> chart to review values.</p>
